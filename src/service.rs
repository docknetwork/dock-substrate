...
use dock_testnet_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi};
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = sc_service::ServiceBuilder::new_full::<
			dock_testnet_runtime::opaque::Block, dock_testnet_runtime::RuntimeApi, crate::service::Executor
		>($config)?
			...
			.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
				...
				let (grandpa_block_import, grandpa_link) =
					grandpa::block_import::<_, _, _, dock_testnet_runtime::RuntimeApi, _>(
