...
impl Filter<Call> for BaseFilter {
    fn filter(call: &Call) -> bool {
        match call {
            ...
            Call::PoAModule(_) => false,
            Call::Utility(_) => false,
            Call::DIDModule(_) => false,
            Call::Revoke(_) => false,
            Call::BlobStore(_) => false,
            Call::MigrationModule(_) => false,
            Call::Anchor(_) => false,
            Call::Attest(_) => false,
            Call::SimpleDemocracy(_) => false,
            Call::Council(_) => false,
            Call::CouncilMembership(_) => false,
            Call::TechnicalCommittee(_) => false,
            Call::TechnicalCommitteeMembership(_) => false,
            Call::Scheduler(_) => false,
            Call::Ethereum(_) => false,
            Call::EVM(_) => false,
            Call::PriceFeedModule(_) => false,
            _ => true,
        }
    }
}
