...
pub fn get_data_for_unrevocation(index: usize) -> (u32, PublicKey, Vec<[u8; 32]>, DidSignature) {
    assert!(index < REV_DATA_SIZE);
    let pk: [u8; 32] = [
        148, 100, 216, 225, 97, 58, 241, 170, 98, 204, 176, 198, 252, 175, 132, 126, 146, 142, 158,
        251, 192, 105, 166, 78, 180, 164, 110, 210, 173, 14, 30, 33,
    ];
    if index == 0 {
        // 1 revocation id
        (
            ...
            PublicKey::Sr25519(Bytes32 { value: pk }),
            [[
                103, 88, 210, 252, 196, 2, 108, 107, 39, 255, 139, 45, 49, 224, 180, 95, 125, 110,
                9, 56, 28, 223, 169, 251, 38, 41, 84, 13, 247, 213, 118, 155,
            ]]
            .to_vec(),
            DidSignature::Sr25519(Bytes64 {
                value: [
                    168, 27, 41, 244, 27, 20, 197, 238, 6, 71, 121, 135, 205, 50, 206, 245, 231,
                    22, 91, 117, 115, 218, 70, 182, 98, 129, 50, 130, 74, 127, 155, 31, 124, 171,
                    85, 76, 1, 130, 230, 6, 33, 227, 6, 132, 188, 86, 91, 33, 254, 88, 59, 216,
                    116, 200, 148, 171, 229, 87, 186, 190, 4, 176, 254, 131,
                ],
            }),
        )
    } else if index == 1 {
        ...
        (
            ...
            [
                [
                    103, 88, 210, 252, 196, 2, 108, 107, 39, 255, 139, 45, 49, 224, 180, 95, 125,
                    110, 9, 56, 28, 223, 169, 251, 38, 41, 84, 13, 247, 213, 118, 155,
                ],
                [
                    94, 45, 149, 143, 192, 152, 68, 254, 39, 87, 116, 176, 151, 130, 10, 184, 78,
                    181, 25, 245, 253, 36, 119, 188, 165, 79, 87, 10, 175, 172, 7, 29,
                ],
            ]
            .to_vec(),
            DidSignature::Sr25519(Bytes64 {
                value: [
                    52, 147, 34, 59, 205, 204, 129, 215, 21, 195, 21, 196, 193, 12, 110, 215, 104,
                    69, 189, 226, 244, 163, 216, 149, 214, 161, 0, 115, 13, 113, 78, 88, 97, 146,
                    224, 43, 93, 182, 242, 80, 1, 86, 14, 252, 16, 30, 250, 134, 251, 24, 232, 153,
                    189, 163, 246, 21, 2, 111, 165, 172, 219, 136, 169, 137,
                ],
            }),
        )
    } else {
        ...
        (
            ...
            [
                ...
                [
                    113, 81, 20, 119, 24, 168, 164, 108, 59, 180, 202, 194, 94, 63, 118, 234, 140,
                    59, 25, 204, 71, 99, 72, 236, 246, 146, 74, 173, 207, 175, 57, 226,
                ],
            ]
            .to_vec(),
            DidSignature::Sr25519(Bytes64 {
                value: [
                    106, 17, 237, 35, 201, 48, 175, 234, 132, 174, 97, 170, 15, 186, 206, 106, 67,
                    199, 245, 110, 74, 239, 141, 61, 133, 134, 44, 160, 235, 165, 97, 112, 95, 47,
                    59, 19, 11, 134, 43, 41, 116, 179, 135, 97, 4, 90, 123, 131, 119, 252, 81, 12,
                    171, 119, 9, 33, 221, 62, 61, 101, 173, 21, 86, 140,
                ],
            }),
        )
    }
