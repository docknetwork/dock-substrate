...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    fn update_sr25519(r: u32) -> Weight {
        Weight::from_ref_time(64_636_000) // Standard Error: 0
            .saturating_add(Weight::from_ref_time(4_000).saturating_mul(r as u64))
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    fn update_ed25519(r: u32) -> Weight {
        Weight::from_ref_time(61_918_000) // Standard Error: 0
            .saturating_add(Weight::from_ref_time(3_000).saturating_mul(r as u64))
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    fn update_secp256k1(r: u32) -> Weight {
        Weight::from_ref_time(157_081_000) // Standard Error: 0
            .saturating_add(Weight::from_ref_time(3_000).saturating_mul(r as u64))
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    ...
    fn create(_r: u32, c: u32) -> Weight {
        Weight::from_ref_time(12_569_000) // Standard Error: 4_000
            .saturating_add(Weight::from_ref_time(66_000).saturating_mul(c as u64))
